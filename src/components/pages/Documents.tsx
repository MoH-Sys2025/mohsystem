...
import UploadDocumentForm from "@/components/UploadDocumentsForm.tsx";
  ...
  return (
      upload ? <UploadDocumentForm /> :  <div className="space-y-8 py-6 px-2">
              ...
              <div className="flex items-center justify-between">
                  ...
                  <Button onClick={()=> setUpload(true)} className="text-sm cursor-pointer bg-gray-100 border-2 px-3 border-dashed rounded-lg text-gray hover:bg-gray-200 flex items-center gap-2">
